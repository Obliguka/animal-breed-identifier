...
# Сохраняем адаптер для BERT
model.save_pretrained("./bert-lora-final")
tokenizer.save_pretrained("./bert-lora-final")
print("Обучение BERT завершено. Адаптер сохранён в ./bert-lora-final")